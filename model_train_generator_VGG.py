...
index_train_val, index_test, y_train_val, y_test = train_test_split(index, labels, stratify=labels, test_size=0.2, random_state=9001)
index_train, index_val, y_train, y_val = train_test_split(index_train_val, y_train_val, stratify=y_train_val, test_size=0.2, random_state=9001)
